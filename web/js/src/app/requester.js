define(function(require, exports, module) {
  //send函数
  var contextPath = "http://activity.itrip.com/";
  var send = function (type, api, parameters, success,error,async) {
    var request = $.ajax({
      url: api + "?callback=?&channel=0",
      data: parameters,
      type: type,
      async: true,
      cache: false,
  ...
  module.exports={
    ...
    checkLogin:function(data,callback){//检查登录
      return send("get",contextPath + "activity/checkLogin",data,callback);
    }
  }
});